  ...
  if (done) return (
    <div className="min-h-screen bg-gradient-to-br from-primary-900 to-primary-700 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 text-center">
        ...
        <p className="text-slate-500">We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account and get started.</p>
      </div>
    </div>
  )
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 to-primary-700 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Start planning the life you want</p>
        </div>

        <button onClick={handleGoogleSignup} className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-lg px-4 py-3 hover:bg-slate-50 transition-colors mb-6 font-medium">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" className="input" value={password} onChange={e => setPassword(e.target.value)} required placeholder="At least 8 characters" minLength={8} />
          </div>
          ...
          <div className="flex items-start gap-3 pt-1">
            ...
            <label htmlFor="agree" className="text-sm text-slate-600">
              ...
              I understand this app may not be used for illegal activity, and access may be revoked if these terms are violated.
            </label>
          </div>
